...
Maintain and improve the project documentation.
{{ args.focus }}
...
1. **Users who want to use this project** — they need to understand
   the core concepts, API, CLI flags, and how to get the most out of
   the tool. Get them productive fast.

2. **Project growth** — people discovering this project need to
   immediately understand what it does, why it matters, and how to get
   started. First impressions count: landing page, README, SEO, and
   visual polish all matter here.
...
- **Keep all surfaces in sync.** When something user-facing changes,
  check: `docs/`, `README.md`, and any quick-reference pages.
...
- **Think jobs-to-be-done**, not feature lists. Frame docs around
  what the user is trying to accomplish, not what the code exposes.
